...
public class CrossValidationSingleRunUsingGridTraining {
	...
	public static void main(String[] args) throws Exception {
		...
		BufferedReader reader = new BufferedReader(
				new FileReader("E:/D_disk/workspace/WaveCluster_PrivTHREM/dataset/deritative-15-clusters-30k-unit-0.01.arff"));
		
//		BufferedReader reader = new BufferedReader(
//				new FileReader("E:/D_disk/workspace/WaveCluster_PrivTHREM/dataset/deritative-spiral-30k-unit-0.01.arff"));
		
//		BufferedReader reader = new BufferedReader(
//				new FileReader("E:/D_disk/workspace/WaveCluster_PrivTHREM/dataset/deritative-aggregation-30k-unit-0.01.arff"));
		...
		builder.setMatlabStartingDirectory(new File(
				"C:/Users/Ling Chen/Desktop/WaveClusterSet/WaveCluster_code_PrivTHREM/"));
		...
		for (int r = 0; r < 1; r++) {
			...
			for (int n = 0; n < folds; n++) {
				...
				double delta = 1;// 其实可以不用，不需要synthesize private pts
				...
				double xmax = 963731;
				double ymax = 972296;
				double epsilon4count = 1.4;
				double epsilon4PValue = 0.6; 
...
//				double xmax = 964418;
//				double ymax = 955379;
//				double epsilon4count = 0.07;
//				double epsilon4PValue = 0.03; 
...
//				double epsilon4PValue = 0.03; 
				...
				//15-clusters-10k
//				int num_partition = 64;
//				String density_threshold = "58%";
//				double xmin = 20506;
//				double ymin = 51970;
//				double xmax = 963505;
//				double ymax = 971788;
//				double epsilon4count = 0.7;
//				double epsilon4PValue = 0.3; 
...
//				double epsilon4PValue = 0.3; 
				...
				String trainFile = "E:/D_disk/workspace/WaveCluster_PrivTHREM/data_experiments/15-clusters-train-"
						+ r + "-" + n + ".arff";
				saver1.setInstances(train);
				saver1.setFile(new File(trainFile));
				saver1.writeBatch();

				String trainFileCSV = "E:/D_disk/workspace/WaveCluster_PrivTHREM/data_experiments/15-clusters-train-"
						+ r + "-" + n + ".csv";
				...
				String testFile = "E:/D_disk/workspace/WaveCluster_PrivTHREM/data_experiments/15-clusters-test-"
						+ r + "-" + n + ".csv";
				...
				String point2GridTestFileWLabel = "E:/D_disk/workspace/WaveCluster_PrivTHREM/data_experiments/data2gridForTestDataWLabel-" + exeID + ".csv";
				///////////////////////////////////////////////////////////////
				
				
				

				String testprocessfile = "E:/D_disk/workspace/WaveCluster_PrivTHREM/data_experiments/15-clusters-test-"
						+ r + "-" + n + "-processed.csv";

				
				String trueTrainMergeLabelFile = "E:/D_disk/workspace/WaveCluster_PrivTHREM/data_experiments/15-clusters-train-true-"
						+ r + "-" + n + "-cluster.csv";
...
//				String inputTrueTrainFile = "E:/D_disk/workspace/PrivateWaveCluster1_improved/data_experiments/siggrid-true-" + density_threshold + "-" + num_partition + "-15-clusters-train-" + r + "-" + n + ".txt";
//				String trueTrainMergeLabelFile = "E:/D_disk/workspace/PrivateWaveCluster1_improved/data_experiments/Grid2Point-siggrid-true-"+ density_threshold + "-" + num_partition +"-15-clusters-" + r + "-" + n + ".csv";
//				Grid2PointForTrain(inputTrueTrainFile, trueTrainMergeLabelFile, num_partition);
				...
				String wekatruefile = "E:/D_disk/workspace/WaveCluster_PrivTHREM/data_experiments/wekaclassfile-true-"
						+ r + "-" + n + ".txt";
				
				String traintestprocessfile = "E:/D_disk/workspace/WaveCluster_PrivTHREM/data_experiments/15-clusters-truetest-"
						+ r + "-" + n + "-processed.csv";
...
//				System.out.println("truetrainData.numClasses():" + t);
				RewriteClassLabelForCSVFile(trueTrainMergeLabelFile, point2GridTestFileWLabel,
				...
				String privateMergeLabelFile = "E:/D_disk/workspace/WaveCluster_PrivTHREM/data_experiments/siggrid-private-synthesized-"
						+ r + "-" + n + ".csv";
				
				////////////修改private train data, 更新参数num_partition/////////////////
				// covert private grid to point, need to update num_partition
//				String inputPrivateTrainFile = "E:/D_disk/workspace/PrivateWaveCluster1_improved/data_experiments/siggrid-private-" + density_threshold + "-" + num_partition + "-15-clusters-train-" + r + "-" + n + ".txt";
//				String privateMergeLabelFile = "E:/D_disk/workspace/PrivateWaveCluster1_improved/data_experiments/Grid2Point-siggrid-private-" + density_threshold + "-" + num_partition + "-15-clusters-" + r + "-" + n + ".csv";
//				Grid2PointForTrain(inputPrivateTrainFile, privateMergeLabelFile, num_partition);
				
				
				/////////////////////////////////////
				///////////////////////////////////// rewrite private test case
				RewriteClassLabelForCSVFile(privateMergeLabelFile, point2GridTestFileWLabel, testprocessfile);
				...
				String wekaprivatefile = "E:/D_disk/workspace/WaveCluster_PrivTHREM/data_experiments/wekaclassfile-private-"
						+ r + "-" + n + ".txt";
...
//	}
	...
	public static int WaveCluster(MatlabProxy proxy, String trainFile, int r,
		...
		String matlabInputfile = "E:/D_disk/workspace/WaveCluster_PrivTHREM/data_experiments/15-clusters-train-"
				+ r + "-" + i + "-processed.csv";
		...
		////////////修改trueTrain data, 更新参数num_partition/////////////////
		// need to update parameter num_partition
		String inputTrueTrainFile = "E:/D_disk/workspace/WaveCluster_PrivTHREM/data_experiments/siggrid-true-" + p_threshold + "-" + p_partition + "-15-clusters-train-" + r + "-" + i + ".txt";
		String trueTrainMergeLabelFile = "E:/D_disk/workspace/WaveCluster_PrivTHREM/data_experiments/Grid2Point-siggrid-true-"+ p_threshold + "-" + p_partition +"-15-clusters-" + r + "-" + i + ".csv";
		Grid2PointForTrain(inputTrueTrainFile, trueTrainMergeLabelFile, num_partition);
		...
		String trueMergeLabelFile = "E:/D_disk/workspace/WaveCluster_PrivTHREM/data_experiments/15-clusters-train-true-"
				+ r + "-" + i + "-cluster.csv";
		PrintWriter f1 = new PrintWriter(new FileWriter(trueMergeLabelFile));
//		String trueClusterLabel = "E:/D_disk/workspace/PrivateWaveCluster1_improved/data_experiments/cluster-true-" + exeID
//				+ ".txt";
		String trueClusterLabel = "E:/D_disk/workspace/WaveCluster_PrivTHREM/data_experiments/siggrid-true-" + p_threshold + "-" + p_partition + "-15-clusters-train-" + r + "-" + i + ".txt";
...
//			System.out.println("split[0] is: " + split[0] + ", split[1] is: " + split[1] + ", idmap.get(label) is: " + idmap.get(label));
		...
		String synthesizedPointsLabelFile = "E:/D_disk/workspace/WaveCluster_PrivTHREM/data_experiments/siggrid-private-synthesized-"
				+ r + "-" + i + ".csv";
		...
		////////////修改private train data, 更新参数num_partition/////////////////
		// covert private grid to point, need to update num_partition
		String inputPrivateTrainFile = "E:/D_disk/workspace/WaveCluster_PrivTHREM/data_experiments/siggrid-private-"
				+ exeID + ".txt";
		String privateMergeLabelFile = "E:/D_disk/workspace/WaveCluster_PrivTHREM/data_experiments/Grid2Point-siggrid-private-" + p_threshold + "-" + p_partition + "-15-clusters-" + r + "-" + i + ".csv";
		Grid2PointForTrain(inputPrivateTrainFile, privateMergeLabelFile, num_partition);
...
//		out_track.close();
	...
	{	
		...
		String tempFile = "E:/D_disk/workspace/WaveCluster_PrivTHREM/data_experiments/TestDataTemp-" + exeID + ".txt";
		...
		String data2gridTestFile = "E:/D_disk/workspace/WaveCluster_PrivTHREM/data_experiments/data2gridForTestData-" + exeID + ".txt";
		BufferedReader reader1 = new BufferedReader(new FileReader(data2gridTestFile));
		
		String data2gridTestFileWLabel = "E:/D_disk/workspace/WaveCluster_PrivTHREM/data_experiments/data2gridForTestDataWLabel-" + exeID + ".csv";
