...
public class UsefulnessHungarianMapping {
	...
	public static void main(String[] args) throws IOException {
		...
		FileWriter fstream = new FileWriter(
				"E:/D_disk/workspace/PrivateWaveCluster1/data_experiments/Hungarian-Results.txt");
		...
		for (Entry<String, String> entry : filemap.entrySet()) {
			...
			ArrayList<ArrayList<Integer>> oriClusters = originalClusters(trueFileName);
...
//				System.out.println(privateClusters.get(y).toString());
		...
		//	 privateClusters = oriClusters;
			...
			double accuracy = intersect / testsize;
