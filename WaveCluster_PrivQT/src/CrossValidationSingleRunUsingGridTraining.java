...
//				new FileReader("E:/D_disk/workspace/WaveCluster_PrivQT/dataset/deritative-15-clusters-30k-unit-0.01.arff"));
//		BufferedReader reader = new BufferedReader(
//				new FileReader("E:/D_disk/workspace/WaveCluster_PrivQT/dataset/deritative-spiral-30k-unit-0.01.arff"));
		BufferedReader reader = new BufferedReader(
				new FileReader("E:/D_disk/workspace/WaveCluster_PrivQT/dataset/deritative-aggregation-30k-unit-0.01.arff"));
		...
		builder.setMatlabStartingDirectory(new File(
				"C:/Users/Ling Chen/Desktop/WaveClusterSet/WaveCluster_code_PrivQT/"));
...
//				double xmin = 0.171872421;
//				double ymin = 1.005733819;
//				double xmax = 15.39829028;
//				double ymax = 15.19579575;
//				double epsilon4count = 1.0;
				
	
				String trainFile = "E:/D_disk/workspace/WaveCluster_PrivQT/data_experiments/15-clusters-train-"
						+ r + "-" + n + ".arff";
				saver1.setInstances(train);
				saver1.setFile(new File(trainFile));
				saver1.writeBatch();

				String trainFileCSV = "E:/D_disk/workspace/WaveCluster_PrivQT/data_experiments/15-clusters-train-"
						+ r + "-" + n + ".csv";
				...
				String testFile = "E:/D_disk/workspace/WaveCluster_PrivQT/data_experiments/15-clusters-test-"
						+ r + "-" + n + ".csv";
				...
				String point2GridTestFileWLabel = "E:/D_disk/workspace/WaveCluster_PrivQT/data_experiments/data2gridForTestDataWLabel-" + exeID + ".csv";
				///////////////////////////////////////////////////////////////
				
				
				

				String testprocessfile = "E:/D_disk/workspace/WaveCluster_PrivQT/data_experiments/15-clusters-test-"
						+ r + "-" + n + "-processed.csv";

				
				String trueTrainMergeLabelFile = "E:/D_disk/workspace/WaveCluster_PrivQT/data_experiments/15-clusters-train-true-"
						+ r + "-" + n + "-cluster.csv";
...
//				String inputTrueTrainFile = "E:/D_disk/workspace/WaveCluster_PrivQT_improved/data_experiments/siggrid-true-" + density_threshold + "-" + num_partition + "-15-clusters-train-" + r + "-" + n + ".txt";
//				String trueTrainMergeLabelFile = "E:/D_disk/workspace/WaveCluster_PrivQT_improved/data_experiments/Grid2Point-siggrid-true-"+ density_threshold + "-" + num_partition +"-15-clusters-" + r + "-" + n + ".csv";
//				Grid2PointForTrain(inputTrueTrainFile, trueTrainMergeLabelFile, num_partition);
				...
				String wekatruefile = "E:/D_disk/workspace/WaveCluster_PrivQT/data_experiments/wekaclassfile-true-"
						+ r + "-" + n + ".txt";
				
				String traintestprocessfile = "E:/D_disk/workspace/WaveCluster_PrivQT/data_experiments/15-clusters-truetest-"
						+ r + "-" + n + "-processed.csv";
...
//				System.out.println("truetrainData.numClasses():" + t);
				...
				String privateMergeLabelFile = "E:/D_disk/workspace/WaveCluster_PrivQT/data_experiments/siggrid-private-synthesized-"
						+ r + "-" + n + ".csv";
				
				////////////修改private train data, 更新参数num_partition/////////////////
				// covert private grid to point, need to update num_partition
//				String inputPrivateTrainFile = "E:/D_disk/workspace/WaveCluster_PrivQT_improved/data_experiments/siggrid-private-" + density_threshold + "-" + num_partition + "-15-clusters-train-" + r + "-" + n + ".txt";
//				String privateMergeLabelFile = "E:/D_disk/workspace/WaveCluster_PrivQT_improved/data_experiments/Grid2Point-siggrid-private-" + density_threshold + "-" + num_partition + "-15-clusters-" + r + "-" + n + ".csv";
//				Grid2PointForTrain(inputPrivateTrainFile, privateMergeLabelFile, num_partition);
				...
				String wekaprivatefile = "E:/D_disk/workspace/WaveCluster_PrivQT/data_experiments/wekaclassfile-private-"
						+ r + "-" + n + ".txt";
...
//	}
	...
	public static int WaveCluster(MatlabProxy proxy, String trainFile, int r,
		...
		String matlabInputfile = "E:/D_disk/workspace/WaveCluster_PrivQT/data_experiments/15-clusters-train-"
				+ r + "-" + i + "-processed.csv";
		...
		////////////修改trueTrain data, 更新参数num_partition/////////////////
		// need to update parameter num_partition
		String inputTrueTrainFile = "E:/D_disk/workspace/WaveCluster_PrivQT/data_experiments/siggrid-true-" + p_threshold + "-" + p_partition + "-15-clusters-train-" + r + "-" + i + ".txt";
		String trueTrainMergeLabelFile = "E:/D_disk/workspace/WaveCluster_PrivQT/data_experiments/Grid2Point-siggrid-true-"+ p_threshold + "-" + p_partition +"-15-clusters-" + r + "-" + i + ".csv";
		Grid2PointForTrain(inputTrueTrainFile, trueTrainMergeLabelFile, num_partition);
		...
		String trueMergeLabelFile = "E:/D_disk/workspace/WaveCluster_PrivQT/data_experiments/15-clusters-train-true-"
				+ r + "-" + i + "-cluster.csv";
		PrintWriter f1 = new PrintWriter(new FileWriter(trueMergeLabelFile));
//		String trueClusterLabel = "E:/D_disk/workspace/WaveCluster_PrivQT_improved/data_experiments/cluster-true-" + exeID
//				+ ".txt";
		String trueClusterLabel = "E:/D_disk/workspace/WaveCluster_PrivQT/data_experiments/siggrid-true-" + p_threshold + "-" + p_partition + "-15-clusters-train-" + r + "-" + i + ".txt";
...
//			System.out.println("split[0] is: " + split[0] + ", split[1] is: " + split[1] + ", idmap.get(label) is: " + idmap.get(label));
		...
		String synthesizedPointsLabelFile = "E:/D_disk/workspace/WaveCluster_PrivQT/data_experiments/siggrid-private-synthesized-"
				+ r + "-" + i + ".csv";
		...
		////////////修改private train data, 更新参数num_partition/////////////////
		// covert private grid to point, need to update num_partition
		String inputPrivateTrainFile = "E:/D_disk/workspace/WaveCluster_PrivQT/data_experiments/siggrid-private-"
				+ exeID + ".txt";
		String privateMergeLabelFile = "E:/D_disk/workspace/WaveCluster_PrivQT/data_experiments/Grid2Point-siggrid-private-" + p_threshold + "-" + p_partition + "-15-clusters-" + r + "-" + i + ".csv";
		Grid2PointForTrain(inputPrivateTrainFile, privateMergeLabelFile, num_partition);
...
//		out_track.close();
	...
	{	
		...
		String tempFile = "E:/D_disk/workspace/WaveCluster_PrivQT/data_experiments/TestDataTemp-" + exeID + ".txt";
		...
		String data2gridTestFile = "E:/D_disk/workspace/WaveCluster_PrivQT/data_experiments/data2gridForTestData-" + exeID + ".txt";
		BufferedReader reader1 = new BufferedReader(new FileReader(data2gridTestFile));
		
		String data2gridTestFileWLabel = "E:/D_disk/workspace/WaveCluster_PrivQT/data_experiments/data2gridForTestDataWLabel-" + exeID + ".csv";
