...
public class CrossValidationSingleRun {
	...
	public static void main(String[] args) throws Exception {
		...
		BufferedReader reader = new BufferedReader(
				new FileReader("E:/D_disk/workspace/BaselineWaveCluster/dataset/10k-15-clusters-0.arff"));
		...
		builder.setMatlabStartingDirectory(new File(
				"C:/Users/Ling Chen/Desktop/WaveCluster_approach-Baseline/"));
		...
		for (int r = 0; r < 1; r++) {
			...
			for (int n = 0; n < folds; n++) {
				...
				int privateclustertotal = WaveCluster(proxy, trainFileCSV, r, n, 64, "58%", 22505, 52969, 961355, 968806, 2, 1.0, 0.3);
	...
	public static int WaveCluster(MatlabProxy proxy, String trainFile, int r,
			int i, int p_partition, String p_threshold, int p_xmin, int p_ymin, int p_xmax, int p_ymax, double delta, double epsilonForCountMatrix, double epsilonForPercentile) throws Exception {
