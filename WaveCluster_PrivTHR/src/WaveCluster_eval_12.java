...
public class WaveCluster_eval_12 {
	...
	public static void main(String[] args) throws Exception {
		...
		String datafile = "deritative-15-clusters-30k-unit-0.01.csv";
//		String datafile = "deritative-spiral-30k-unit-0.01.csv";
//		String datafile = "deritative-aggregation-30k-unit-0.01.csv";
		
		String[] densityThresholdArray = new String[] { "60%" };
		int[] num_partitionArray = new int[] { 48 };
		double epsilonForCountMatrix = 2.0;
		...
		/////////////////////////
		////////////////////////
		double epsilonForPercentile = 0.3; // this is NOT USED. 
		...
		// proxy.eval("a = csvread('sampledata.csv')");
		// // Print a value of the array into the MATLAB Command Window
		// proxy.eval("gscatter(a(:,1), a(:,2), WaveCluster_Private2(a, [], 8, '30%', 1, 'bior2.2', 0,'test'))");
