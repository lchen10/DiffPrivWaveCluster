...
//		print2DArray(cost, "%.1f\t", "\nNow the cost matrix becomes:", 0);
	...
	public static void main(String[] args) throws IOException {
		...
		FileWriter fstream = new FileWriter("E:/D_disk/workspace/WaveCluster_PrivTHR/data_experiments/Dissimilarity_2.txt");
		...
		// E:\Clusters\output
		File outputFolder = new File("E:/D_disk/workspace/WaveCluster_PrivTHR/data_experiments");
		...
		for (Entry<String, String> entry : filemap.entrySet()) {
			...
			String trueFileName = "E:/D_disk/workspace/WaveCluster_PrivTHR/data_experiments/" + entry.getKey();
			String privateFileName = "E:/D_disk/workspace/WaveCluster_PrivTHR/data_experiments/" + entry.getValue();
